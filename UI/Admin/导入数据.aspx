...
.fileupload,.textBox{
    ...
    <tr>
        <td colspan="3">
            <asp:TextBox ID="TextBox1" class="left" runat="server" Width="60px" CssClass="textBox" ForeColor="White"></asp:TextBox>会计系
            <asp:TextBox ID="TextBox2" runat="server" Width="60px" CssClass="textBox" ForeColor="White"></asp:TextBox>信息工程系
            <asp:TextBox ID="TextBox3" runat="server" Width="60px" CssClass="textBox" ForeColor="White"></asp:TextBox>经济管理系
            <asp:TextBox ID="TextBox4" runat="server" Width="60px" CssClass="textBox" ForeColor="White"></asp:TextBox>食品工程系
            <asp:TextBox ID="TextBox5" runat="server" Width="60px" CssClass="textBox" ForeColor="White"></asp:TextBox>机械工程系
            <asp:TextBox ID="TextBox6" runat="server" Width="60px" CssClass="textBox" ForeColor="White"></asp:TextBox>商务外语系
            <asp:TextBox ID="TextBox7" runat="server" Width="60px" CssClass="textBox" ForeColor="White"></asp:TextBox>建筑工程系
