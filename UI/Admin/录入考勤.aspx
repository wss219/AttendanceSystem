<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="录入考勤.aspx.cs" Inherits="Admin_录入考勤" %>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td style="width:20%;height:25px" class="STYLE1">
                    <asp:Button ID="btnClick" CssClass="btn" Text="考勤" Width="100px" runat="server" OnClick="BtnSubmit_Click" />
                </td>
    ...
    <asp:Repeater ID="rptHomework" runat="server" OnItemCommand="rptHomework_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td style="width:20%;height:25px" class="STYLE1">
                    <asp:Button ID="btnHomeworkClick" CssClass="btn" Text="批改" Width="100px" runat="server" OnClick="BtnHomeworkSubmit_Click" />
                </td>
